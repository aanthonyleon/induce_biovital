...
?>
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" data-sidebar="off" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled sidebar-enabled">
								...
								<div class="card">
									...
									<div class="card-header">
										...
										<div class="card-toolbar">
											...
											<?php if ($permiso_Agregar_calendario === "true") { ?>
											<button class="btn btn-flex btn-primary me-2" data-bs-toggle="modal" data-bs-target="#modalAgendar">
											<i class="ki-duotone ki-plus fs-2"></i>Agendar</button>
											<?php } ?>

										

<!-- 											<select id="mi-select" style="width: 300px;">
				        ...
				        <option value="opcion4">Opción 4</option>
								...
								<div class="modal fade" id="kt_modal_add_event" tabindex-="1" aria-hidden="true" data-bs-focus="false">
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											<!--begin::Form-->
											<div class="form" action="#" id="kt_modal_add_event_form">
												<!--begin::Modal header-->
								...
								<!--begin::Modal - New Product-->
								<div class="" id="kt_modal_view_event">
				...
				<div class="modal-content shadow-none">
					<div class="container w-lg-800px">
						...
						<div class="modal-body">
							...
							<div>
								<h3 class="text-gray-900 fw-bold fs-1 mb-6">Framework Users</h3>
								<!--begin::List Widget 4-->
							...
							<!--begin::Tutorials-->
							<div class="pb-10">
								<h3 class="text-gray-900 fw-bold fs-1 mb-6">Tutorials</h3>
								<!--begin::List Widget 5-->
								<div class="card mb-5 shadow-none">
									...
									<div class="card-body pt-2 px-0">
										...
										<div class="d-flex mb-6">
											<!--begin::Icon-->
											<div class="me-1">
												<i class="ki-duotone ki-right text-sm text-primary"></i>
											</div>
											<!--end::Icon-->
											<!--begin::Content-->
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <textarea id="servicio_descripcion" class="form-control" placeholder="Escribe aquí..."></textarea>
		      </div>
		      <div class="modal-footer">
		        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
		        <button type="button" class="btn btn-primary" onclick="agregar_servicio()">Guardar</button>
		      </div>
		    </div>
		  </div>
		</div>
		...
		<div class="modal fade" id="modalAgendar" tabindex="-1" aria-labelledby="modalAgendarLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="modalAgendarLabel">Agregar servicio</h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
		      ...
		      <div class="modal-body py-10 px-lg-17">
				...
				<div class="fv-row mb-9">
					<input type="hidden" id="clienteNuevo" value="false">

					<!--begin::Label-->
					<label class="fs-6 fw-semibold required mb-2">Cliente</label>
					<!--end::Label-->

					<select id="id_cliente" data-control="select2" class="form-control" onchange="get_cliente2()">
		                ...
		                ?>
	                	<option value="<?php echo $cliente_id; ?>"><?php echo $cliente_nombre; ?> - Tel: <?php echo $cliente_telefono; ?></option>
	                <?php 
	                		}
	                	}
	                ?>
	                	<option value="agregar">Agregar cliente</option>
					</select>

					<!-- <input list="clientes" id="id_cliente" name="id_cliente" class="form-control" placeholder="Escribe aquí..."> -->
					<div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
					  <button class="btn btn-primary me-md-2" type="button" id="no-coincidencia-btn" style="display: none;" onclick="mostrarFormulario()"><i class="ki-duotone ki-plus fs-2"></i> Crear nuevo cliente</button>
					</div>
					...
					<!-- <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="id_cliente" onchange="get_cliente()">
					...
					// 		$cliente_telefono = $array->telefono;
	                ?>
	                	<option value="<?php // echo $cliente_id; ?>" selected><?php // echo $cliente_nombre; ?> - Tel: <?php // echo $cliente_telefono; ?></option>
	                <?php 
	                // 	}
	                // }
	                ?>
				...
				<div id="show-cliente" style="display: none;">
					<div class="fv-row mb-9">
						<!--begin::Label-->
						<label class="fs-6 fw-semibold mb-2">Nombre completo</label>
						<!--end::Label-->
						<!--begin::Input-->
						<input type="text" class="form-control form-control-solid" placeholder="Escribe aquí..." id="nuevo_nombre" />
						<!--end::Input-->
					</div>
					...
					<div class="fv-row mb-9">
						...
						<!--end::Label-->
						<!--begin::Input-->
						<input type="text" class="form-control form-control-solid" placeholder="Escribe aquí..." id="nuevo_telefono" />
						<!--end::Input-->
					</div>

					<!-- <div class="d-grid gap-2 d-md-flex justify-content-md-end">
					  <button class="btn btn-primary me-md-2" type="button" onclick="agregar_cliente()">Agregar</button>
					</div> -->
				</div>

				<div id="show-cliente2" style="display: block;">
					<div class="fv-row mb-9">
						<!--begin::Label-->
						<label class="fs-6 fw-semibold mb-2">Teléfono</label>
						<!--end::Label-->
						<!--begin::Input-->
						<input type="text" class="form-control form-control-solid" placeholder="Escribe aquí..." id="telefono" />
						<!--end::Input-->
					</div>
					<!--end::Input group-->
				</div>
				...
				<div class="fv-row mb-9">
					...
					<!--end::Label-->
					<select class="form-control" data-control="select2" data-hide-search="true" id="id_servicio" onchange="get_horarios_servicio()">
						<option value="" disabled selected>Selecciona una opción</option>
					<?php 
					if ($rservicios)
					{
				...
				<div class="row">
					<div class="col-12">
						<div class="fv-row mb-9">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<input type="date" class="form-control form-control-solid" name="calendar_event_start_date" placeholder="Selecciona la fecha" id="kt_calendar_datepicker_start_date" onchange="get_horarios_servicio()"/>
							<!--end::Input-->
						</div>
					</div>
					...
					<div class="col-6" data-kt-calendar="datepicker">
						<div class="fv-row mb-9">
							...
							<!--end::Label-->
							<select class="form-control" data-control="select2" data-hide-search="true" id="kt_calendar_datepicker_start_time" onchange="get_hora_fin()">
								<option value="" disabled selected>Selecciona una hora</option>
							</select>

							<!-- <select class="form-control" data-control="select2" data-hide-search="true" id="kt_calendar_datepicker_start_time" >
					...
					<div class="col-6" data-kt-calendar="datepicker">
						<div class="fv-row mb-9">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<!-- <input type="time" class="form-control form-control-solid" name="calendar_event_end_time" placeholder="Selecciona la hora" id="kt_calendar_datepicker_end_time" /> -->
							<!--end::Input-->

							<select class="form-control" data-control="select2" data-hide-search="true" id="kt_calendar_datepicker_end_time">
								<option value="" disabled selected>Selecciona una hora</option>
							</select>
						</div>
					</div>
		      ...
		      <div class="modal-footer">
		        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
		        <button type="button" class="btn btn-primary" onclick="agregar_calendario()">Agregar</button>
		      </div>
		    </div>
		  </div>
		</div>
		...
		<div class="modal fade" id="modalEditarAgenda" tabindex="-1" aria-labelledby="modalEditarAgendaLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="modalEditarAgendaLabel">Editar agenda</h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
		      
		      <div class="modal-body">
		      	<div id="results-edit"></div>
			  </div>
		    </div>
		  </div>
		</div>
		...
		<!-- Modal -->
		<div class="modal fade" id="modalEliminarAgenda" tabindex="-1" aria-labelledby="modalEliminarAgendaLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="modalEliminarAgendaLabel">Eliminar agenda</h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
		      
		      <div class="modal-body">
		      	<h3>¿Seguro que deseas eliminar de tu calendario?</h3>
			  </div>

			  <div class="modal-footer">
		        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
		        <button type="button" class="btn btn-danger" onclick="eliminar_calendario()">Sí, eliminar</button>
		      </div>
		    </div>
		  </div>
		</div>
		...
		<!-- Modal GET AGENDA -->
		<div class="modal fade" id="modalGetAgenda" tabindex="-1" aria-labelledby="modalGetAgendaLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="modalGetAgendaLabel">Detalles</h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
		      <div class="modal-body">
		      	<input type="hidden" id="id_agenda_editar" value="">
		      	<div id="results-agenda"></div>
		      </div>
		    </div>
		  </div>
		</div>
		...
		<script>
		    ...
		    document.getElementById("id_cliente").addEventListener("input", function() {
		        ...
		        var noCoincidenciaBtn = document.getElementById("no-coincidencia-btn");
		        var coincide = false;
		        ...
		        if (!coincide && input.value.trim() !== "") {
		            noCoincidenciaBtn.style.display = "block";
		        } else {
		            noCoincidenciaBtn.style.display = "none";
		        }
		    });
		    ...
		    document.getElementById('id_cliente').addEventListener('change', function() {
			    ...
			    get_cliente(clienteId);
			});

			// document.getElementById('editar_id_cliente').addEventListener('change', function() {
			//     var selectedOption = document.querySelector('#editar_clientes option[value="' + this.value + '"]');
			//     var clienteId = selectedOption ? selectedOption.getAttribute('data-cliente-id') : null;
			//     console.log('ID del cliente seleccionado:', clienteId);
		...
		<script>
	        $(document).ready(function() {
	            ...
	            $('#modalAgendar').on('shown.bs.modal', function () {
	                ...
	                $('#kt_calendar_datepicker_start_time').select2({
	                    dropdownParent: $('#modalAgendar')
	                });

	                $('#kt_calendar_datepicker_end_time').select2({
	                    dropdownParent: $('#modalAgendar')
	                });
	            });
	        });
    	...
    	<script type="text/javascript">
    		function showEventHours() {
        // Ocultar todas las horas primero
        var timeSlots = document.querySelectorAll('.fc-timegrid-slot');
        timeSlots.forEach(function(slot) {
          slot.style.display = 'none';
        });

        // Mostrar solo las horas que tienen eventos
        calendar.getEvents().forEach(function(event) {
          var startHour = event.start.getHours();
          var endHour = event.end.getHours();

          for (var i = startHour; i <= endHour; i++) {
            var timeSlot = document.querySelector('.fc-timegrid-slot[data-time="' + i + ':00:00"]');
            if (timeSlot) {
